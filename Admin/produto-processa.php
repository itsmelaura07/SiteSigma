...
<main>
    <h2> Produto processa</h2>
    <a href ="produto-processa.php">Inserir</a>
    <br>
    <table border="1">
        <tr>
       <th>Id</th>
...
<tr>
    ...
    <td><a href= "produto-processa.php?acao-salvar&id<?php echo $dado['CategoriaID'];?>"><?php echo $dado['Nome'];?></a></td>
